...
<div class="d-lg-flex align-items-lg-start justify-content-lg-between flex-lg-row-reverse">
    ...
    <div class="post_container post_container--left">
        <div class="post_container__wrapper">
            <div class="post_container__wallpaper" style="background: #F4F6F9 url({$post->image|resize:1100:600:false:$config->resized_blog_dir}) no-repeat center center;background-size: contain;">
                {* Post category label *}
