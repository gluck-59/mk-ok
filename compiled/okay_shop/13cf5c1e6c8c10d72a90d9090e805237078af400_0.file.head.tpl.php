...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_67096d5e08c383_39402532',
...
function content_67096d5e08c383_39402532 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
    <meta property="og:description" content="<?php if (!empty($_smarty_tpl->tpl_vars['annotation']->value)) {
echo trim(htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['annotation']->value), ENT_QUOTES, 'UTF-8', true));
} else {
echo trim(htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['description']->value), ENT_QUOTES, 'UTF-8', true));
}?>">
...
">
    <meta name="twitter:description" content="<?php if (!empty($_smarty_tpl->tpl_vars['annotation']->value)) {
echo trim(htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['annotation']->value), ENT_QUOTES, 'UTF-8', true));
} else {
echo trim(htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['description']->value), ENT_QUOTES, 'UTF-8', true));
}?>">
