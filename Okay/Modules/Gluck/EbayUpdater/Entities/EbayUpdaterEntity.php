...
//        'id',
    ...
    public function getUpdated() {
        ...
        $sql->setStatement("SELECT id, variant_id, newEbayItem_id, old_currency_id, new_currency_id, old_price, new_price, DATE_FORMAT(updated, '%d.%m.%Y <br>в %H:%i') upd_date, success, description FROM ".self::getTable()." 
        ...
        foreach ($fieldsTemp as $field) {
            ...
            $field->sku = $variant->name ? $variant->sku : '';
            $fields[] = $field;
        }
        return $fields;
    }
