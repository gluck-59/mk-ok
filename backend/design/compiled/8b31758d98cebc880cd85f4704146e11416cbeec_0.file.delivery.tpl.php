<?php
/* Smarty version 3.1.40, created on 2023-04-30 08:48:16
  from '/Users/gluck/Sites/okaycms/backend/design/html/delivery.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_644de5002631f2_57475649',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8b31758d98cebc880cd85f4704146e11416cbeec' => 
    array (
      0 => '/Users/gluck/Sites/okaycms/backend/design/html/delivery.tpl',
      1 => 1682807751,
      2 => 'file',
    ),
  ),
...
function content_644de5002631f2_57475649 (Smarty_Internal_Template $_smarty_tpl) {
...
"/>
                        ...
                        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"delivery_general"),$_smarty_tpl ) );?>
            ...
            <div class="boxed fn_toggle_wrap ">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="activity_of_switch activity_of_switch--box_settings">
                        <div class="activity_of_switch_item">                             <div class="okay_switch clearfix">
                                <label class="switch_label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->hide_front_delivery_price, ENT_QUOTES, 'UTF-8', true);?>
</label>
                                <label class="switch switch-default">
                                    <input class="switch-input" name="hide_front_delivery_price" value='1' type="checkbox" id="visible_checkbox" <?php if ($_smarty_tpl->tpl_vars['delivery']->value->hide_front_delivery_price) {?>checked=""<?php }?>/>
                                    <span class="switch-label"></span>
                                    <span class="switch-handle"></span>
                                </label>
                            </div>
                        </div>
                        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"delivery_switch_checkboxes"),$_smarty_tpl ) );?>
...
" alt="" />
                ...
                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"delivery_image"),$_smarty_tpl ) );?>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="fn_step-4 boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <button type="button" class="btn btn-small btn-outline-warning fn_type_delivery delivery_type <?php if ($_smarty_tpl->tpl_vars['delivery']->value->paid) {?>active<?php }?>" data-type="paid">
                                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->delivery_paid, ENT_QUOTES, 'UTF-8', true);?>

                            </button>
                            <button type="button" class="btn btn-small btn-outline-warning fn_type_delivery delivery_type <?php if (!$_smarty_tpl->tpl_vars['delivery']->value->paid) {?>active<?php }?>" data-type="free">
                                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->deliveries_free, ENT_QUOTES, 'UTF-8', true);?>

                            </button>
                            <input type="hidden" name="delivery_type" value="<?php if ($_smarty_tpl->tpl_vars['delivery']->value->paid) {?>paid<?php } else { ?>free<?php }?>" />
                        </div>
                    </div>
                    <div class="row fn_delivery_option <?php if (!$_smarty_tpl->tpl_vars['delivery']->value->paid) {?>hidden<?php }?> mt-1">
                        <div class="col-lg-12 col-md-12">
...
" />
                            ...
                            <div class="delivery_inline_block mt-1 activity_of_switch_item">                                 <div class="activity_of_switch_item">
                                    <div class="okay_switch clearfix">
                                        <label class="switch_label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_paid_separately, ENT_QUOTES, 'UTF-8', true);?>
</label>
                                        <label class="switch switch-default">
                                            <input class="switch-input" name="separate_payment" value='1' type="checkbox" id="visible_checkbox" <?php if ($_smarty_tpl->tpl_vars['delivery']->value->separate_payment) {?>checked=""<?php }?>/>
                                            <span class="switch-label"></span>
                                            <span class="switch-handle"></span>
                                        </label>
                                    </div>
                    ...
                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"delivery_price_block"),$_smarty_tpl ) );?>
    ...
    <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"delivery_custom_block"),$_smarty_tpl ) );
                        ...
                        <div class="col-lg-6 pr-0">
                            <div class="form-group clearfix">
                                ...
                                <select name="module_id" class="selectpicker form-control">
                                    ...
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['delivery_modules']->value, 'delivery_module');
$_smarty_tpl->tpl_vars['delivery_module']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['delivery_module']->value) {
$_smarty_tpl->tpl_vars['delivery_module']->do_else = false;
?>
                                        <option value="<?php echo $_smarty_tpl->tpl_vars['delivery_module']->value->id;?>
" <?php if ($_smarty_tpl->tpl_vars['delivery']->value->module_id == $_smarty_tpl->tpl_vars['delivery_module']->value->id) {?>selected<?php }?> ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['delivery_module']->value->vendor, ENT_QUOTES, 'UTF-8', true);?>
/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['delivery_module']->value->module_name, ENT_QUOTES, 'UTF-8', true);?>
</option>
                                    <?php
}
...
$_smarty_tpl->tpl_vars['delivery_module']->do_else = false;
?>
                        <div class="row fn_module_settings" <?php if ($_smarty_tpl->tpl_vars['delivery_module']->value->id != $_smarty_tpl->tpl_vars['delivery']->value->module_id) {?>style="display:none;"<?php }?> data-module_id="<?php echo $_smarty_tpl->tpl_vars['delivery_module']->value->id;?>
">
                            <div class="col-lg-12 col-md-12 heading_box"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['delivery_module']->value->vendor, ENT_QUOTES, 'UTF-8', true);?>
/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['delivery_module']->value->module_name, ENT_QUOTES, 'UTF-8', true);?>
</div>
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['delivery_module']->value->settings, 'setting');
                                ...
                                <?php if (!empty($_smarty_tpl->tpl_vars['setting']->value->options) && count($_smarty_tpl->tpl_vars['setting']->value->options) > 1) {?>
                                    <div class="col-lg-6">
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="">
                                                <select name="delivery_settings[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->variable, ENT_QUOTES, 'UTF-8', true);?>
...
?>
                                                        <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value->value, ENT_QUOTES, 'UTF-8', true);?>
" <?php if ((isset($_smarty_tpl->tpl_vars['delivery']->value->delivery_settings[$_smarty_tpl->tpl_vars['setting']->value->variable])) && $_smarty_tpl->tpl_vars['option']->value->value == $_smarty_tpl->tpl_vars['delivery']->value->delivery_settings[$_smarty_tpl->tpl_vars['setting']->value->variable]) {?>selected<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</option>
                                                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <?php } else { ?>
                                    <div class="col-lg-6" style="height: 75px;">
                                        <div class="form-group clearfix">
                                            ...
                                            <?php if ($_smarty_tpl->tpl_vars['setting']->value->type == 'checkbox') {?>
                                                <label class="heading_label" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->variable, ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</label>
                                                <div class="boxes_inline">
                                                    
                                                    <input name="delivery_settings[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->variable, ENT_QUOTES, 'UTF-8', true);?>
]" class="hidden_check" type="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->type, ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->value, ENT_QUOTES, 'UTF-8', true);?>
" <?php if ($_smarty_tpl->tpl_vars['setting']->value->value == $_smarty_tpl->tpl_vars['delivery']->value->delivery_settings[$_smarty_tpl->tpl_vars['setting']->value->variable]) {?>checked<?php }?> id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->variable, ENT_QUOTES, 'UTF-8', true);?>
"/>
                                                    <label class="okay_ckeckbox" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->variable, ENT_QUOTES, 'UTF-8', true);?>
"></label>
                                                </div>
                                            <?php } else { ?>
                                                <label class="heading_label" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->variable, ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->name, ENT_QUOTES, 'UTF-8', true);?>
                                                ...
                                                <div>
                                                    <input name="delivery_settings[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->variable, ENT_QUOTES, 'UTF-8', true);?>
]" class="form-control" type="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->type, ENT_QUOTES, 'UTF-8', true);?>
" value="<?php if ((isset($_smarty_tpl->tpl_vars['delivery']->value->delivery_settings[$_smarty_tpl->tpl_vars['setting']->value->variable]))) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['delivery']->value->delivery_settings[$_smarty_tpl->tpl_vars['setting']->value->variable], ENT_QUOTES, 'UTF-8', true);
}?>" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->variable, ENT_QUOTES, 'UTF-8', true);?>
"/>
                                                </div>
                                            <?php }?>
                                        </div>
...
" <?php if (in_array($_smarty_tpl->tpl_vars['payment_method']->value->id,$_smarty_tpl->tpl_vars['delivery']->value->delivery_payments)) {?>checked<?php }?> type="checkbox" name="delivery_payments[]">
                                    <label for="id_<?php echo $_smarty_tpl->tpl_vars['payment_method']->value->id;?>
" class="okay_ckeckbox <?php if (in_array($_smarty_tpl->tpl_vars['payment_method']->value->id,$_smarty_tpl->tpl_vars['delivery']->value->delivery_payments)) {?>active_payment<?php }?>">
...
<?php $_smarty_tpl->_subTemplateRender('file:learning_hints.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('hintId'=>'hint_delivery'), 0, false);
?>
