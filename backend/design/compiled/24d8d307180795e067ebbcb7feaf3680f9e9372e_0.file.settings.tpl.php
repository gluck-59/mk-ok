...
/* Smarty version 3.1.40, created on 2024-10-11 23:26:48
  from '/Users/gluck/Sites/motokofr.ok/Okay/Modules/OkayCMS/Feeds/Backend/design/html/presets/yml/settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_67096de8640313_33150377',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '24d8d307180795e067ebbcb7feaf3680f9e9372e' => 
    array (
      0 => '/Users/gluck/Sites/motokofr.ok/Okay/Modules/OkayCMS/Feeds/Backend/design/html/presets/yml/settings.tpl',
      1 => 1728664430,
      2 => 'file',
    ),
  ),
...
function content_67096de8640313_33150377 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="boxed">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__company;?>
</span>
            </div>
            <div class="mb-1">
...
" />
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__feed_name;?>
</span>
            </div>
            <div class="mb-1">
                <input class="form-control" type="text" name="settings[feed_name]" value="<?php echo $_smarty_tpl->tpl_vars['feed']->value->settings['feed_name'];?>
" />
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__store, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                            <input class="switch-input" name="settings[store]" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['store']) {?>checked=""<?php }?>/>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__pickup, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                            <input class="switch-input" name="settings[pickup]" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['pickup']) {?>checked=""<?php }?>/>
                            <span class="switch-label"></span>
                            <span class="switch-handle"></span>
                        </label>
                    </div>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__has_manufacturer_warranty, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                            <input class="switch-input" name="settings[has_manufacturer_warranty]" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['has_manufacturer_warranty']) {?>checked=""<?php }?>/>
                            <span class="switch-label"></span>
                            <span class="switch-handle"></span>
                        </label>
                    </div>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__delivery, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                            <input class="switch-input" name="settings[delivery]" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['delivery']) {?>checked=""<?php }?>/>
                            <span class="switch-label"></span>
                            <span class="switch-handle"></span>
                        </label>
                    </div>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__adult, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__enable_auto_discounts, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                            <input class="switch-input" name="settings[enable_auto_discounts]" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['enable_auto_discounts']) {?>checked=""<?php }?>/>
                            <span class="switch-label"></span>
                            <span class="switch-handle"></span>
                        </label>
                    </div>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__count, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                            <input class="switch-input" name="settings[count]" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['count']) {?>checked=""<?php }?>/>
                            <span class="switch-label"></span>
                            <span class="switch-handle"></span>
                        </label>
                    </div>
...
<div class="boxed">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__country_of_origin;?>
</span>
            </div>
            <div class="mb-1">
                <select name="settings[country_of_origin]" class="selectpicker">
                    <option <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['country_of_origin'] == 0) {?>selected=""<?php }?> value=""></option>
                    <?php
...
?>
                        <option <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['country_of_origin'] == $_smarty_tpl->tpl_vars['feature']->value->id) {?>selected=""<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['feature']->value->id;?>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__upload_without_images, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__upload_only_in_stock_products, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__no_export_without_price, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__use_full_description, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__description_in_html, ENT_QUOTES, 'UTF-8', true);?>
</span>
                            <i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__yml__description_in_html_info, ENT_QUOTES, 'UTF-8', true);?>
">
...
<?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"okay_cms__feeds__feed__settings__yml__custom_block"),$_smarty_tpl ) );
$_prefixVariable4 = ob_get_clean();
$_smarty_tpl->_assignInScope('block', $_prefixVariable4);
