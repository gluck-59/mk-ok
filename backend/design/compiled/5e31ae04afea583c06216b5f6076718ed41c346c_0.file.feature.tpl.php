<?php
/* Smarty version 3.1.40, created on 2023-05-02 00:30:29
  from '/Users/gluck/Sites/motokofr.ok/backend/design/html/feature.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_6450135586bef6_37597418',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5e31ae04afea583c06216b5f6076718ed41c346c' => 
    array (
      0 => '/Users/gluck/Sites/motokofr.ok/backend/design/html/feature.tpl',
      1 => 1682807751,
      2 => 'file',
    ),
  ),
...
function content_6450135586bef6_37597418 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'category_select' => 
  array (
    'compiled_filepath' => '/Users/gluck/Sites/motokofr.ok/backend/design/compiled/5e31ae04afea583c06216b5f6076718ed41c346c_0.file.feature.tpl.php',
    'uid' => '5e31ae04afea583c06216b5f6076718ed41c346c',
    'call_name' => 'smarty_template_function_category_select_2027844712645013557427b9_01331609',
  ),
));
...
" />
                            ...
                            <div class="col-xl-6 col-lg-6 col-sm-12">
                                <div class="fn_step-3">
                                    ...
                                    <div class="heading_label__switch heading_label__switch--not_label">
                                        <div class="heading_label boxes_inline">
                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->feature_show_in_product, ENT_QUOTES, 'UTF-8', true);?>

                                        </div>
                                        <div class="boxes_inline">
                                            <div class="okay_switch clearfix">
                                                <label class="switch switch-default">
                                                    <input class="switch-input" name="show_in_product" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['feature']->value->show_in_product) {?>checked=""<?php }?>/>
                                                    <span class="switch-label"></span>
                                                    <span class="switch-handle"></span>
                                                </label>
                                            </div>
                        ...
                        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"feature_general"),$_smarty_tpl ) );?>

                    </div>
                    <div class="col-lg-4 col-md-3 col-sm-12">
                        <div class="activity_of_switch">
                            <div class="activity_of_switch_item">                                 <div class="fn_step-4 okay_switch clearfix">
                                    <label class="switch_label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_enable, ENT_QUOTES, 'UTF-8', true);?>
</label>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="visible" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['feature']->value->visible) {?>checked=""<?php }?>/>
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                </div>
...
?>
        ...
        <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"feature_switch_checkboxes"),$_smarty_tpl ) );
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="alert alert--icon alert--error">
                        <div class="alert__content">
                            ...
                            <p><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->feature_message, ENT_QUOTES, 'UTF-8', true);?>
</p>
                        </div>
                    </div>
...
?>
                        <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->feature_select_all_categories, ENT_QUOTES, 'UTF-8', true);?>
</span>
                    </button>
                ...
                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"feature_categories"),$_smarty_tpl ) );?>
...
"/>
                    ...
                    <textarea class="form-control okay_textarea" name="description"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value->description, ENT_QUOTES, 'UTF-8', true);?>
</textarea>
                </div>
                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"feature_meta_data"),$_smarty_tpl ) );?>
    ...
    <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"feature_custom_block"),$_smarty_tpl ) );
...
?>
                    ...
                    <button data-hint="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_sort_feature_values_alphabet_hint, ENT_QUOTES, 'UTF-8', true);?>
" class="btn btn_mini btn_border_light text_400 mb-1 hint-bottom-right-t-info-s-small-mobile hint-anim" type="submit" name="alphabet_sort_values" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_sort_feature_values_alphabet, ENT_QUOTES, 'UTF-8', true);?>
">
                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_sort_feature_values_alphabet, ENT_QUOTES, 'UTF-8', true);?>
                    ...
                    <div class="okay_list ok_related_list">
                        <div class="okay_list_head">
                            ...
                            <div class="okay_list_heading feature_value_name">
                                <?php echo $_smarty_tpl->tpl_vars['btr']->value->feature_value_name;?>
...
?>
                                    ...
                                    <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"feature_value_item",'vars'=>array('fv'=>$_smarty_tpl->tpl_vars['fv']->value)),$_smarty_tpl ) );
...
?>
        ...
        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"feature_merge_values"),$_smarty_tpl ) );?>
...
<?php $_smarty_tpl->_subTemplateRender('file:learning_hints.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('hintId'=>'hint_feature'), 0, false);
?>
...
<?php }
/* smarty_template_function_category_select_2027844712645013557427b9_01331609 */
if (!function_exists('smarty_template_function_category_select_2027844712645013557427b9_01331609')) {
function smarty_template_function_category_select_2027844712645013557427b9_01331609(Smarty_Internal_Template $_smarty_tpl,$params) {
...
' <?php if (in_array($_smarty_tpl->tpl_vars['category']->value->id,$_smarty_tpl->tpl_vars['feature_categories']->value)) {?>selected<?php }?> category_name='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->single_name, ENT_QUOTES, 'UTF-8', true);?>
'><?php
