...
/* Smarty version 3.1.40, created on 2024-10-11 23:26:48
  from '/Users/gluck/Sites/motokofr.ok/Okay/Modules/OkayCMS/Feeds/Backend/design/html/presets/rozetka/settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_67096de85d14a6_23901605',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fc98249e551d38d087c23da0cc060f273fb5ccfd' => 
    array (
      0 => '/Users/gluck/Sites/motokofr.ok/Okay/Modules/OkayCMS/Feeds/Backend/design/html/presets/rozetka/settings.tpl',
      1 => 1728664430,
      2 => 'file',
    ),
  ),
...
function content_67096de85d14a6_23901605 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="boxed">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__company;?>
</span>
            </div>
            <div class="mb-1">
...
" />
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__feed_name;?>
</span>
                <i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__feed_name_tooltip, ENT_QUOTES, 'UTF-8', true);?>
">
...
<div class="boxed">
    ...
    <div class="row">
         <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__variant_name_param;?>
</span>
                <i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__variant_name_param_tooltip, ENT_QUOTES, 'UTF-8', true);?>
">
                    <svg width="20px" height="20px" viewBox="0 0 438.533 438.533"><path fill="currentColor" d="M409.133,109.203c-19.608-33.592-46.205-60.189-79.798-79.796C295.736,9.801,259.058,0,219.273,0c-39.781,0-76.47,9.801-110.063,29.407c-33.595,19.604-60.192,46.201-79.8,79.796C9.801,142.8,0,179.489,0,219.267c0,39.78,9.804,76.463,29.407,110.062c19.607,33.592,46.204,60.189,79.799,79.798c33.597,19.605,70.283,29.407,110.063,29.407s76.47-9.802,110.065-29.407c33.593-19.602,60.189-46.206,79.795-79.798c19.603-33.596,29.403-70.284,29.403-110.062C438.533,179.485,428.732,142.795,409.133,109.203z M255.82,356.309c0,2.662-0.862,4.853-2.573,6.563c-1.704,1.711-3.895,2.567-6.557,2.567h-54.823c-2.664,0-4.854-0.856-6.567-2.567c-1.714-1.711-2.57-3.901-2.57-6.563v-54.823c0-2.662,0.855-4.853,2.57-6.563c1.713-1.708,3.903-2.563,6.567-2.563h54.823c2.662,0,4.853,0.855,6.557,2.563c1.711,1.711,2.573,3.901,2.573,6.563V356.309z M325.338,187.574c-2.382,7.043-5.044,12.804-7.994,17.275c-2.949,4.473-7.187,9.042-12.709,13.703c-5.51,4.663-9.891,7.996-13.135,9.998c-3.23,1.995-7.898,4.713-13.982,8.135c-6.283,3.613-11.465,8.326-15.555,14.134c-4.093,5.804-6.139,10.513-6.139,14.126c0,2.67-0.862,4.859-2.574,6.571c-1.707,1.711-3.897,2.566-6.56,2.566h-54.82c-2.664,0-4.854-0.855-6.567-2.566c-1.715-1.712-2.568-3.901-2.568-6.571v-10.279c0-12.752,4.993-24.701,14.987-35.832c9.994-11.136,20.986-19.368,32.979-24.698c9.13-4.186,15.604-8.47,19.41-12.847c3.812-4.377,5.715-10.188,5.715-17.417c0-6.283-3.572-11.897-10.711-16.849c-7.139-4.947-15.27-7.421-24.409-7.421c-9.9,0-18.082,2.285-24.555,6.855c-6.283,4.565-14.465,13.322-24.554,26.263c-1.713,2.286-4.093,3.431-7.139,3.431c-2.284,0-4.093-0.57-5.424-1.709L121.35,145.89c-4.377-3.427-5.138-7.422-2.286-11.991c24.366-40.542,59.672-60.813,105.922-60.813c16.563,0,32.744,3.903,48.541,11.708c15.796,7.801,28.979,18.842,39.546,33.119c10.554,14.272,15.845,29.787,15.845,46.537C328.904,172.824,327.71,180.529,325.338,187.574z"></path></svg>                    
                </i>
            </div>
            <div class="mb-1">
                <input class="form-control" type="text" name="settings[variant_name_param]" value="<?php echo $_smarty_tpl->tpl_vars['feed']->value->settings['variant_name_param'];?>
" />
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__upload_without_images, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span class="permission_box__label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__upload_only_in_stock_products, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                       <label class="switch switch-default">
                            <input class="switch-input" name="settings[upload_only_products_in_stock]" value='1' type="checkbox" id="visible_checkbox" <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['upload_only_products_in_stock']) {?>checked=""<?php }?>/>
                            <span class="switch-label"></span>
                            <span class="switch-handle"></span>
                        </label>
                    </div>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span class="permission_box__label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__use_full_description, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                       <label class="switch switch-default">
                            <input class="switch-input" name="settings[use_full_description]" value="1" type="checkbox" id="featured_checkbox" <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['use_full_description']) {?>checked=""<?php }?>/>
                            <span class="switch-label"></span>
                            <span class="switch-handle"></span>
                        </label>
                    </div>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__description_in_html, ENT_QUOTES, 'UTF-8', true);?>
</span>
                            <i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__rozetka__description_in_html_info, ENT_QUOTES, 'UTF-8', true);?>
">
...
<?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"okay_cms__feeds__feed__settings__rozetka__custom_block"),$_smarty_tpl ) );
