<?php
/* Smarty version 3.1.40, created on 2023-05-01 21:33:16
  from '/Users/gluck/Sites/motokofr.ok/backend/design/html/features.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_644fe9cc480960_05776313',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5046f0a009f76d30200e0126ef8a0159c88970dc' => 
    array (
      0 => '/Users/gluck/Sites/motokofr.ok/backend/design/html/features.tpl',
      1 => 1682807751,
      2 => 'file',
    ),
  ),
...
function content_644fe9cc480960_05776313 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'category_select' => 
  array (
    'compiled_filepath' => '/Users/gluck/Sites/motokofr.ok/backend/design/compiled/5046f0a009f76d30200e0126ef8a0159c88970dc_0.file.features.tpl.php',
    'uid' => '5046f0a009f76d30200e0126ef8a0159c88970dc',
    'call_name' => 'smarty_template_function_category_select_1856612536644fe9cc3acf08_28394263',
  ),
));
...
<div class="main_header">
 ...
 - <?php echo $_smarty_tpl->tpl_vars['features_count']->value;?>
            ...
            <div class="box_btn_heading">
                <a class="btn btn_small btn-info" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('controller'=>'FeatureAdmin','return'=>$_SERVER['REQUEST_URI'],'page'=>null,'limit'=>null),$_smarty_tpl ) );?>
">
        ...
        <div class="main_header__inner">
            <form class="search" method="get">
                ...
                <div class="input-group input-group--search">
                    <input name="keyword" class="form-control" placeholder="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->features_search, ENT_QUOTES, 'UTF-8', true);?>
...
" <?php if ($_smarty_tpl->tpl_vars['current_limit']->value == 100) {?>selected=""<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_show_by, ENT_QUOTES, 'UTF-8', true);?>
 100</option>
    ...
    <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"features_custom_block"),$_smarty_tpl ) );
...
"/>
            ...
            <div class="okay_list products_list fn_sort_list">
                    ...
                    <div class="okay_list_heading feature_value_products_num_title"><?php echo $_smarty_tpl->tpl_vars['btr']->value->product_count_by_feature;?>
</div>
                    ...
                    <div class="okay_list_heading okay_list_status"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->feature_show_in_product, ENT_QUOTES, 'UTF-8', true);?>
</div>
...
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value->position, ENT_QUOTES, 'UTF-8', true);?>
" />
...
"></label>
                            ...
                            <div class="okay_list_boding okay_list_features_name">
                                <a class="link" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('controller'=>'FeatureAdmin','id'=>$_smarty_tpl->tpl_vars['feature']->value->id,'return'=>$_SERVER['REQUEST_URI'],'page'=>null,'limit'=>null),$_smarty_tpl ) );?>
">
                                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value->name, ENT_QUOTES, 'UTF-8', true);?>

                                </a>

                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"features_list_name"),$_smarty_tpl ) );?>
...
$_smarty_tpl->tpl_vars['feature_cat']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['feature_cat']->value) {
$_smarty_tpl->tpl_vars['feature_cat']->do_else = false;
...
/backend/index.php?controller=ProductsAdmin&feature_id=<?php echo $_smarty_tpl->tpl_vars['feature']->value->id;?>
" class="form-control" target="_blank">
                                    <?php if ((isset($_smarty_tpl->tpl_vars['products_counts']->value[$_smarty_tpl->tpl_vars['feature']->value->id]['count']))) {?>
                                        <?php echo $_smarty_tpl->tpl_vars['products_counts']->value[$_smarty_tpl->tpl_vars['feature']->value->id]['count'];?>
                            ...
                            <div class="okay_list_boding okay_list_status">
                                    ...
                                    <input class="switch-input fn_ajax_action <?php if ($_smarty_tpl->tpl_vars['feature']->value->visible) {?>fn_active_class<?php }?>" data-controller="feature" data-action="visible" data-id="<?php echo $_smarty_tpl->tpl_vars['feature']->value->id;?>
" name="visible" value="1" type="checkbox"  <?php if ($_smarty_tpl->tpl_vars['feature']->value->visible) {?>checked=""<?php }?>/>
...
" name="in_filter" value="1" type="checkbox"  <?php if ($_smarty_tpl->tpl_vars['feature']->value->in_filter) {?>checked=""<?php }?>/>
                            ...
                            <div class="okay_list_boding show_in_product">
                                                                <label class="switch switch-default">
                                    <input class="switch-input fn_ajax_action <?php if ($_smarty_tpl->tpl_vars['feature']->value->show_in_product) {?>fn_active_class<?php }?>" data-controller="feature" data-action="show_in_product" data-id="<?php echo $_smarty_tpl->tpl_vars['feature']->value->id;?>
" name="show_in_product" value="1" type="checkbox"  <?php if ($_smarty_tpl->tpl_vars['feature']->value->show_in_product) {?>checked=""<?php }?>/>
                                    <span class="switch-label"></span>
                                    <span class="switch-handle"></span>
                                </label>
                            </div>
...
<?php $_smarty_tpl->_subTemplateRender('file:learning_hints.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('hintId'=>'hint_features'), 0, false);
?>
...
<?php }
/* smarty_template_function_category_select_1856612536644fe9cc3acf08_28394263 */
if (!function_exists('smarty_template_function_category_select_1856612536644fe9cc3acf08_28394263')) {
function smarty_template_function_category_select_1856612536644fe9cc3acf08_28394263(Smarty_Internal_Template $_smarty_tpl,$params) {
...
?>
                                        <option value='<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('keyword'=>null,'category_id'=>$_smarty_tpl->tpl_vars['c']->value->id),$_smarty_tpl ) );?>
