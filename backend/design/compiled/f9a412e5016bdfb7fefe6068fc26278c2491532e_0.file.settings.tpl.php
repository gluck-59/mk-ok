...
/* Smarty version 3.1.40, created on 2024-10-11 23:26:48
  from '/Users/gluck/Sites/motokofr.ok/Okay/Modules/OkayCMS/Feeds/Backend/design/html/presets/price_ua/settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_67096de87494f2_57886589',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f9a412e5016bdfb7fefe6068fc26278c2491532e' => 
    array (
      0 => '/Users/gluck/Sites/motokofr.ok/Okay/Modules/OkayCMS/Feeds/Backend/design/html/presets/price_ua/settings.tpl',
      1 => 1728664430,
      2 => 'file',
    ),
  ),
...
function content_67096de87494f2_57886589 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="boxed">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__company;?>
</span>
            </div>
            <div class="mb-1">
...
" />
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__feed_name;?>
</span>
            </div>
            <div class="mb-1">
...
<div class="boxed">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__country_of_origin;?>
</span>
                 <i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__country_of_origin_tooltip, ENT_QUOTES, 'UTF-8', true);?>
">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__guarantee_shop;?>

            </div>
            <div class="mb-1">
                <select name="settings[guarantee_shop]" class="selectpicker">
                    <option <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['guarantee_shop'] == 0) {?>selected=""<?php }?> value=""></option>
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['features']->value, 'feature');
$_smarty_tpl->tpl_vars['feature']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['feature']->value) {
$_smarty_tpl->tpl_vars['feature']->do_else = false;
?>
                        <option <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['guarantee_shop'] == $_smarty_tpl->tpl_vars['feature']->value->id) {?>selected=""<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['feature']->value->id;?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</option>
                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__guarantee_manufacturer;?>
</span>
            </div>
            <div class="mb-1">
                <select name="settings[guarantee_manufacturer]" class="selectpicker">
                    <option <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['guarantee_manufacturer'] == 0) {?>selected=""<?php }?> value=""></option>
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['features']->value, 'feature');
$_smarty_tpl->tpl_vars['feature']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['feature']->value) {
$_smarty_tpl->tpl_vars['feature']->do_else = false;
?>
                        <option <?php if ($_smarty_tpl->tpl_vars['feed']->value->settings['guarantee_manufacturer'] == $_smarty_tpl->tpl_vars['feature']->value->id) {?>selected=""<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['feature']->value->id;?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</option>
                    <?php
}
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__upload_without_images, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__upload_only_in_stock_products, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__no_export_without_price, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__use_full_description, ENT_QUOTES, 'UTF-8', true);?>
</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__description_in_html, ENT_QUOTES, 'UTF-8', true);?>
</span>
                            <i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okay_cms__feeds__feed__settings__price_ua__description_in_html_info, ENT_QUOTES, 'UTF-8', true);?>
">
...
<?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['get_design_block'][0], array( array('block'=>"okay_cms__feeds__feed__settings__price_ua__custom_block"),$_smarty_tpl ) );
$_prefixVariable6 = ob_get_clean();
$_smarty_tpl->_assignInScope('block', $_prefixVariable6);
