<?php
/* Smarty version 3.1.40, created on 2024-10-11 23:29:20
  from '/Users/gluck/Sites/motokofr.ok/backend/design/html/import_log.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_67096e80bf7539_55849062',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'de062a0ec8848d137f777d73903092b365f301eb' => 
    array (
      0 => '/Users/gluck/Sites/motokofr.ok/backend/design/html/import_log.tpl',
      1 => 1728664428,
      2 => 'file',
    ),
  ),
...
function content_67096e80bf7539_55849062 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="main_header">
 ...
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'plural' ][ 0 ], array( $_smarty_tpl->tpl_vars['logs_count']->value,'товар','товаров','товара' ));?>
            ...
            <?php } else { ?>
                <div class="box_heading heading_page"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->import_log_empty, ENT_QUOTES, 'UTF-8', true);?>
</div>
            <?php }?>
        </div>
    </div>
...
" target="_blank"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['log']->value->product_name, ENT_QUOTES, 'UTF-8', true);?>
                                        ...
                                        <div class="okay_list_boding okay_list_log_status">
                                            <?php if ($_smarty_tpl->tpl_vars['log']->value->status == 'added') {?>
                                                <i class="fa fa-plus font-2xl text-success" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['log']->value->status, ENT_QUOTES, 'UTF-8', true);?>
"></i>
                                            <?php } elseif ($_smarty_tpl->tpl_vars['log']->value->status == 'updated') {?>
                                                <i class="fa fa-refresh font-2xl text-info" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['log']->value->status, ENT_QUOTES, 'UTF-8', true);?>
"></i>
                                            <?php }?>
                                        </div>
                                    </div>
