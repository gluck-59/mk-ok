                ...
                <div>
                    <ul class="mb-0 pl-1">
                        {literal}
                            ...
                            <li><a href="" class="fn_clipboard hint-bottom-middle-t-info-s-small-mobile" data-hint="Click to copy" data-hint-copied="✔ Copied to clipboard">{$manufacturer}</a> - {/literal}{$btr->seo_patterns_ajax_manufacturer_name|escape}</li>{literal}
